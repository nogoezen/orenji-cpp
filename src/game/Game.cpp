...
void Game::mainMenu() {
    std::vector<ConsoleUI::MenuItem> menuItems = {
        {"Nouvelle partie", [this]() { newGame(); }},
        {"Charger une partie", [this]() { loadGame(); }},
        {"Quitter", [this]() { quitGame(); }}
    };
...
void Game::newGame() {
    ...
    m_ui.displayMessage("Une nouvelle aventure commence à Lisbonne. Vous avez reçu une Caravelle pour débuter votre voyage.");
...
// Quitter le jeu
void Game::quitGame() {
    m_ui.displayTitle("QUITTER LE JEU");
    
    std::string confirmation = m_ui.getInput("Êtes-vous sûr de vouloir quitter ? (o/n): ");
    
    if (confirmation == "o" || confirmation == "O") {
        m_ui.displayMessage("Merci d'avoir joué!");
        stop();
    } else {
        mainMenu();
    }
...
void Game::navigationMenu() {
    ...
    std::vector<ConsoleUI::MenuItem> menuItems = {
        {"Nord", [this]() { navigate(0, -1); }},
        {"Sud", [this]() { navigate(0, 1); }},
        {"Est", [this]() { navigate(1, 0); }},
        {"Ouest", [this]() { navigate(-1, 0); }},
        {"Statut", [this]() { statusMenu(); }},
        {"Inventaire", [this]() { inventoryMenu(); }},
...
void Game::cityMenu() {
    ...
    std::vector<ConsoleUI::MenuItem> menuItems = {
        {"Port", [this]() { portMenu(); }},
        {"Commerce", [this]() { tradeMenu(); }},
        {"Chantier naval", [this]() { shipyardMenu(); }},
        {"Taverne", [this]() { tavernMenu(); }},
...
void Game::tradeMenu() {
    ...
    while (trading) {
        ...
        // Options de commerce
        std::vector<ConsoleUI::MenuItem> menuItems = {
            {"Acheter des marchandises", [this]() { tradeBuyMenu(); }},
            {"Vendre des marchandises", [this]() { tradeSellMenu(); }},
            {"Consulter la cargaison", [this]() { inventoryMenu(); }},
            {"Quitter le marché", [&trading]() { trading = false; }}
        };
